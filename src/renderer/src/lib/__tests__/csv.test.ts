...
describe('csv', () => {
  ...
  it("writes one line per log row with the table's fields", () => {
    ...
    expect(line).toContain(',16.0,2,453.062500,FM,DMR,University of Buckingham,,Tune Mode,Search,1,206,,,CC 13,No Tone,,University of Buckingham,RRDB,,University of Buckingham,University of Buckingham,,,3.2,47,');

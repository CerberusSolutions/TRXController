...
export const useIdentities = create<IdentityState>((set) => ({
  ...
  settings: { lat: null, lon: null, radiusKm: 60, units: 'km', scanTimeoutS: null, port: null, autoConnect: true, window: null, rr: { username: '', password: '', coid: null, stid: null, countryName: '', stateName: '' }, lookups: DEFAULT_LOOKUPS.map((p) => ({ ...p })) },
  rr: null,
  rrBusy: false,
  rrMessage: null,
